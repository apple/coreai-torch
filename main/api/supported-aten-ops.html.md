...
- [TorchConverter API reference](TorchConverter.md) — `register_torch_lowering()` for adding or overriding op lowerings.
- [Custom Op Lowering](../guides/custom-op-lowering.md) — tutorial walkthrough.
- [Composite ops API reference](composite-ops.md) — built-in composite op modules.
